...
const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-[#f5f0eb] via-[#e8dfd6] to-[#d6c6b8] px-6 md:px-12 pt-12 relative overflow-hidden">
      {/* Lady Justice image OVERLAY */}
      <img
        src="/assets/images/lady-justice..png"
        alt="Lady Justice"
        className="absolute -top-9 bottom-0 right-[-60px] h-[410px] object-contain z-10 pointer-events-none"
      />

      {/* Footer Container */}
      <footer className="bg-[#0f0f0f] text-white rounded-t-2xl py-12 px-6 relative overflow-hidden z-0">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">

          {/* Branding */}
          <div>
            <h2 className="text-2xl font-bold mb-4">Samadhan</h2>
